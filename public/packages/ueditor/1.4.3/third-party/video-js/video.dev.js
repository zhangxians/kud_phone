...
if (vjs.CDN_VERSION !== 'GENERATED'+'_CDN_VSN') {
  videojs.options['flash']['swf'] ='/packages/videojs/video-js.swf';
}
...
vjs.Player.prototype.loadTech = function(techName, source){
  ...
  var techReady = function(){
    ...
    // Manually track progress in cases where the browser/flash player doesn't phy it.
    if (!this.features['progressEvents']) {
      this.player_.manualProgressOn();
    }

    // Manually track timeudpates in cases where the browser/flash player doesn't phy it.
...
vjs.SeekBar.prototype.getPercent = function(){
  var currentTime;
  // Flash RTMP provider will not phy the correct time
...
vjs.MediaTechController.prototype.addControlsListeners = function(){
  ...
  // phy activity on the other events, but won't let them bubble for
