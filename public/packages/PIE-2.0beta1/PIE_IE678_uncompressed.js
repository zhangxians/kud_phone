...
PIE.BoundsInfo.prototype = {
    ...
    getLiveBounds: function() {
        ...
        return {
            x: rect.left,
            y: rect.top,
            // In some cases scrolling the page will cause IE9 to phy incorrect dimensions
...
PIE.BackgroundStyleInfo = PIE.StyleInfoBase.newStyleInfo( {
     ...
     * to phy is as being "active" if either the -pie-background override property is present
