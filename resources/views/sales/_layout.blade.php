...
<html>
    ...
    <div class="header">
        ...
        <div class="nav-item" style="float: left;">
            ...
            <a href="/order/list" @if(Request::path()=='order/list') class="checked" @endif><span>所有订单</span></a>

            <a href="/order" @if(Request::path()=='order') class="checked" @endif><span>已接单</span></a>

            <a href="/sales" @if(Request::path()=='sales') class="checked" @endif ><span>接单</span></a>
